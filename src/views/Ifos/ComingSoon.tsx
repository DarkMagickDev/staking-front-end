...
import { Button, Text } from '@prodvdjin/dmgk-uikit'
      ...
      <Content>
        <div>
          <Block>
            ...
            <Text mb={3}>
              <LiquidityLink href="https://pancakeswap.finance/add/BNB/0x6F89660fEf8B6a03a41E5F3d0306645BE2469eFE">
                {TranslateString(506, 'Get DMGK-BNB LP >')}
              </LiquidityLink>
            </Text>
            <Text mb={3}>
