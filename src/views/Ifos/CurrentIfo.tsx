...
import { Text, Heading, BaseLayout, Button, LinkExternal, Flex, Image } from '@prodvdjin/dmgk-uikit'
  ...
  return (
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <Flex mb="16px">
            <LinkExternal href="https://pancakeswap.finance/swap" mr="16px">
              {TranslateString(999, 'Buy dmgk')}
            </LinkExternal>
            <LinkExternal href="https://pancakeswap.finance/add/BNB/0x6F89660fEf8B6a03a41E5F3d0306645BE2469eFE">
        ...
        <div>
          <Image src="/images/ifo-bunny.svg" alt="ifo bunny" width={436} height={406} />
          <div>
