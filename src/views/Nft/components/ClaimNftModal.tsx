...
import { Button, Modal, Text } from '@prodvdjin/dmgk-uikit'
...
const ClaimNftModal: React.FC<ClaimNftModalProps> = ({ nft, onSuccess, onDismiss }) => {
  ...
  const cakeBalance = useTokenBalance(getCakeAddress()).balance
  ...
  return (
    <Modal title={TranslateString(999, 'Claim NFT')} onDismiss={onDismiss}>
      ...
      <Actions>
        ...
        <Button onClick={handleConfirm} disabled={!account || isLoading || cakeInWallet <= 0}>
